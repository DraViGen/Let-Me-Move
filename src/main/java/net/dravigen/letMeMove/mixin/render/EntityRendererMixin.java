...
public abstract class EntityRendererMixin {
         ...
         if (instance.thirdPersonView > 0) {
             ...
             if (this.mc.gameSettings.debugCamEnable) {
                 ...
                 for (int var20 = 0; var20 < 8; ++var20) {
                     ...
                     MovingObjectPosition var24 = this.mc.theWorld.clip(this.mc.theWorld.getWorldVec3Pool().getVecFromPool(var4 + (double)(var21 *= 0.1f), var6 + (double)(var22 *= 0.1f), var8 + (double)(var23 *= 0.1f)), this.mc.theWorld.getWorldVec3Pool().getVecFromPool(var4 - var14 + (double)var21 + (double)var23, var6 - var18 + (double)var22, var8 - var16 + (double)var23));
    ...
    private void a(float x, float y, float z) {
        ICustomMovementEntity playerMove = (ICustomMovementEntity) this.mc.thePlayer;
        float rLeaningPitch = 1 - playerMove.letMeMove_$getLeaningPitch();

        rLeaningPitch = playerMove.isPose(EnumPose.SNEAKING) ? 0 : rLeaningPitch;

        if (!playerMove.isPose(EnumPose.STANDING)) {
